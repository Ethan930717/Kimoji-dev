...
return [
    ...
    'can-request'               => '求种',
    'can-upload'                => '发布',
    'certified-banker'          => '小地主',
    'certified-banker-desc'     => '拥有超过50,000魔力',
    'certified-downloader'      => '影迷',
    'certified-downloader-desc' => '下载超过100个资源',
    'certified-seeder'          => '收藏家',
    'certified-seeder-desc'     => '做种数量超过150',
    'change-email'              => '更改邮箱',
    ...
    'created'                   => '封禁时间',
    'created-on'                => '创建于',
    'credited-download'         => '活动下载',
    'credited-upload'           => '活动上传',
    ...
    'disclaimer'                => '免责声明',
    'disclaimer-info'           => '一般来说，我们不会记录用户IP地址，除非你申报了盒子的IP地址，我们才会记录到资料中',
    'disclaimer-info-bordered'  => '当资源包含盒子使用者IP时,会有一个高速出种的标签',
    'download-bon'              => '魔力兑换量',
    ...
    'followers'                     => '粉丝',
    'following'                     => '我推',
    'following-notification'        => '粉丝通知设定',
    'following-notification-upload' => '当你粉的人发布了资源，发出一个通知',
    'following-notification-help'   => '调整你粉的人相关的通知设定。
    若不勾选任何触发用户组，或你已<strong>取消全局性</strong>通知，以下设定将会无效。',
    ...
    'reset-api-token'                 => '重置API口令',
    'reset-api-help'                  => '重置API口令后，你必须在使用了旧口令的所有脚本或程序中更新你的口令',
    'reset-passkey'                   => '重置Passkey',
    'reset-passkey-help'              => '重置Passkey后，你必须重新下载/上传你所有的种子，请谨慎操作',
    'reset-rss'                       => '重置RSSkey',
    'reset-rss-help'                  => '重置RSSkey后，你必须更新所有活跃中的RSS订阅',
    'restore'                         => '回复',
    'resurrections'                   => '救种',
    ...
    'title'                => '头衔',
    'top-bankers'          => '富豪排行榜',
    'top-downloaders-data' => '下载量排行榜',
    'top-leechers'         => '下载数排行榜',
    'top-leechers-count'   => '下载数',
    'top-seeders'          => '保种数排行榜',
    'top-seeders-count'    => '做种数排行班',
    'top-seeding-size'     => '做种量排行榜',
    'top-seedtime'         => '做种时间排行榜',
    'top-uploaders-data'   => '上传量排行榜',
    'topics'               => '主题',
