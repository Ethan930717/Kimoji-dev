            ...
            <form class="form">
                <div class="form__group--short-horizontal">
                    ...
                    <p class="form__group">
                        ...
                        <label class="form__label form__label--floating" for="ip">IP</label>
                    </p>
                    <p class="form__group">
                        <input id="port" wire:model="port" class="form__text" placeholder=" ">
                        <label class="form__label form__label--floating" for="port">端口</label>
                    </p>
                    <p class="form__group">
                    ...
                    <p class="form__group">
                        <select id="connectivity" wire:model="connectivity" class="form__select" placeholder=" ">
                            ...
                            <option value="connectable">已连接</option>
                            <option value="unconnectable">未连接</option>
                        </select>
