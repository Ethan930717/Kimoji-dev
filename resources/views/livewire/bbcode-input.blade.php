...
>
    <p class="bbcode-input__tabs">
        ...
        <menu class="bbcode-input__icon-bar" x-cloak x-show="showButtons">
            ...
            <li>
                <button type="button" class="form__button form__button--text" x-on:click="showOneClickButtons = ! showOneClickButtons">一键模板</button>
            </li>
            <menu class="bbcode-input__icon-bar" x-cloak x-show="showOneClickButtons">
                <li><button type="button" class="form__button form__button--text" x-on:click="ConfirmMovieTrans">影视转载</button></li>
                <li><button type="button" class="form__button form__button--text" x-on:click="ConfirmMusicTrans">音乐转载</button></li>
                <li><button type="button" class="form__button form__button--text" x-on:click="ConfirmVoiceTrans">有声转载</button></li>
