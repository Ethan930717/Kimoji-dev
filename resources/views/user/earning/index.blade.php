            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th>{{ __('torrent.pertorrent') }}</th>
                        <th>{{ __('torrent.hourly') }}</th>
                        <th x-cloak x-show="extendStats">{{ __('torrent.daily') }}</th>
                        <th x-cloak x-show="extendStats">{{ __('torrent.weekly') }}</th>
                        <th x-cloak x-show="extendStats">{{ __('torrent.monthly') }}</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
