                        ...
                        <dialog class="dialog" x-ref="dialog">
                            ...
                            <div x-on:click.outside="$refs.dialog.close()">
                                ...
                                >
                                    @csrf
                                    <p class="form__group">
                                        <select name="freeleech" class="form__select use-select2">
                                    ...
                                    <p class="form__group">
                                        <select class="form__select use-select2" name="fl_until">
                        ...
                        <dialog class="dialog" x-ref="dialog">
                            ...
                            <div x-on:click.outside="$refs.dialog.close()">
                                ...
                                >
                                    @csrf
                                    <p class="form__group">
                                        <select class="form__select use-select2" name="du_until">
                                            <option value="">永久</option>
                                            <option value="1">1 天</option>
                                            <option value="2">2 天</option>
                                            <option value="3">3 天</option>
