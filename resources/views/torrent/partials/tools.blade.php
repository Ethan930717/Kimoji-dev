                            ...
                            <dialog class="dialog" x-ref="dialog">
                                ...
                                >
                                    ...
                                    <div class="form__group">
                                        <button type="button" class="form__button--mod" onclick="insertText('规范主标题命名，详见[url=https://kimoji.club/pages/3]发布规则[/url]\n')">标题</button>
                                        <button type="button" class="form__button--mod" onclick="insertText('请提交完整的 Mediainfo 扫描信息\n')">Mediainfo</button>
                                        <button type="button" class="form__button--mod" onclick="insertText('原盘请提供BDinfo，详见[url=https://kimoji.club/pages/4]原盘发布规则[/url]\n')">BDinfo</button>
                                        <button type="button" class="form__button--mod" onclick="insertText('请检查基本信息填写：类别/媒介等\n')">基本信息</button>
                                        <button type="button" class="form__button--mod" onclick="insertText('请补充TMDb/IMDb信息\n')">T/IMDb</button>
                                        <button type="button" class="form__button--mod" onclick="insertText('提供至少三张 BBCODE 格式的截图（非缩略图），原盘则需提供PNG原图\n')">截图</button>
                                        <button type="button" class="form__button--mod" onclick="insertText('请按固定的格式编辑描述信息，详见[url=https://kimoji.club/pages/3]发布规则[/url]或参考已发布的资源\n')">描述格式</button>
                                    </div>
                                    <p class="form__group">
                                        <textarea
                                            id="message"
