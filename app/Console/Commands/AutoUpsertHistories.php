            ...
            DB::transaction(function () use ($histories): void {
                History::upsert(
                    ...
                    [
                        ...
                        'seedtime' =>     DB::raw('GREATEST(0, IF(DATE_ADD(updated_at, INTERVAL 5400 SECOND) > VALUES(updated_at) AND seeder = 1 AND VALUES(seeder) = 1, seedtime + TIMESTAMPDIFF(SECOND, updated_at, VALUES(updated_at)), seedtime))'),
