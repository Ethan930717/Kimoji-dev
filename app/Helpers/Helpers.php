...
if (!\function_exists('language_flag')) {
    function language_flag($language)
    {
        $flag = match ($language) {
            ...
            'Sichuan' => 'sichuan',
            '未知'      => 'unknown',
            'Chinese', 'Mandarin', 'Mandarin (Hans)', 'Mandarin (Hant)', 'Cantonese', 'Cantonese (Hant)', 'Chinese (Simplied)', 'Chinese (Traditional)', 'Chinese (Simplified)', 'Chinese-yue-Hant', 'Chinese-cmn-Hans', 'Chinese-cmn-Hant',  '国语', '普通话' => 'cn',
